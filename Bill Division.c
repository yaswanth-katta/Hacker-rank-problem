...
If Brian did not overcharge Anna, print Bon Appetit on a new line; otherwise, print the difference (i.e., ) that Brian must refund to Anna.
...
int main(){
    ...
    total-=a[k];
    int result=paid-(total/2);
    if(result==0) printf("Bon Appetit\n");
    else printf("%d\n",result);
}
